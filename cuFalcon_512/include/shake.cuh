...
__global__ void i_shake256_flip_gpu_kernel(uint64_t *scA, uint64_t  *scdptr, size_t d_mem_pool_pitch);
...
__global__ void i_shake256_init_gpu_kernel(uint64_t *scA, uint64_t *d_scdptr, size_t d_mem_pool_pitch);
