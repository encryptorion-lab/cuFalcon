...
__global__ void comp_encode_gpu(uint8_t *d_buf, size_t max_out_len, const int16_t *d_x, unsigned logn, uint32_t *d_len, size_t d_mem_pool_pitch)
{
    size_t n, u, v;
    uint32_t acc;
    unsigned acc_len;
